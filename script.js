...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const expandedPost = document.getElementById("EntradaExpandida"); // Contenedor del modal
  const expandedImg = document.getElementById("EntradaImagen");     // Imagen del modal
  const expandedTitle = document.getElementById("EntradaTitulo");   // Título del modal
  const expandedText = document.getElementById("EntradaTexto");     // Texto del modal
